...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	KC_LCTL, KC_LALT, KC_LGUI, MO(2),            KC_SPC,  MO(1),            KC_RALT, KC_RCTL, MO(3),            KC_LEFT, KC_DOWN, KC_RGHT
	),

	[1] = LAYOUT(
	RESET,   _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_MPLY,
